...
export const en: Dict = {
  ...
  landing: {
    ...
    faq: [
      ...
      { q: 'Does it work for ISIL, USIL, UPC or Universidad de Lima?', a: 'Yes, and it is worth saying how precise this is. ISIL publishes that its Potential Assessment measures Verbal Aptitude and Mathematical Reasoning, and its mock is built from those two areas. The other institutions do not publish how much each area weighs, so our proportions are a reasonable estimate, not official data: they train you on the format and the clock, not on predicting the paper. None of these institutions is affiliated with RUMBO.' },
  ...
  app: {
    ...
    quickExamBody: 'Timed questions in the institution’s format. No hints until the end.',
