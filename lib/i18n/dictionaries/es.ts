...
export const es = {
  common: {
    ...
    whatsapp: 'Coordinar el pago por WhatsApp',
    language: 'Idioma',
    menu: 'Menú',
  ...
  wa: {
    ...
    info: 'Hola, quiero coordinar el pago de RUMBO.',
    short: 'Hola, quiero coordinar un pago de RUMBO.',
  ...
  proof: {
    ...
    extras: [
      ...
      ['Simulacros cronometrados', 'Con el formato de cada institución y el reloj corriendo.'],
    ],
    startupTitle: 'Con las cartas sobre la mesa',
    startupBody:
      'RUMBO es un proyecto joven, hecho en Lima. Reúne en un solo sitio cuatro métodos que ya están probados por separado: repetición espaciada, práctica recuperativa, aprendizaje visual y retroalimentación inmediata. Lo que aporta es tenerlos juntos, ordenados y al alcance de una familia peruana, con el temario del examen peruano y precios en soles. Crece cada semana, y si algo no encaja, se escucha y se corrige.',
  },
  ...
  landing: {
    ...
    offerBody:
      'RUMBO está en su primer año y crece cada semana. Mientras dure esta etapa, todo cuesta un 40 % menos que la tarifa que tendrá después. Quien entre ahora conserva su precio mientras siga renovando: no sube en la siguiente convocatoria.',
    offerUntil: 'Hasta el 31/12/2026',
    ...
    englishPrice: '{price} al mes por separado · sin pagar nada extra si tienes el Pase de Admisión o el plan Familiar',
    ...
    faq: [
      ...
      { q: '¿Puedo comprar un solo curso en vez de todo?', a: 'Sí. Cada módulo se vende por separado, al mes o al año; el precio de cada uno está arriba, en la sección de módulos. Si tu hijo solo necesita reforzar Razonamiento Verbal, pagas ese. Los planes completos salen a cuenta a partir de tres módulos.' },
      ...
      { q: '¿Sirve para ISIL, USIL, UPC o Universidad de Lima?', a: 'Sí, y conviene decir hasta dónde llega la precisión. ISIL publica que su Evaluación de Potencial mide Aptitud Verbal y Razonamiento Matemático, y su simulacro se arma con esas dos áreas. Las demás instituciones no publican cuánto pesa cada área, así que nuestras proporciones son una estimación razonable, no un dato oficial: te sirven para entrenar el formato y el reloj, no para predecir el examen. Ninguna de estas instituciones tiene vínculo con RUMBO.' },
    ...
    footerSupport: 'Coordinar mi pago',
  ...
  guide: {
    ...
    steps: [
      ...
      },
      {
        ...
        time: '25 min',
        body: 'Examen completo, cronometrado y con el formato de la institución que elijas. Sin pistas hasta entregar, como el día de verdad.',
  ...
  app: {
    ...
    quickExamBody:
      'Preguntas cronometradas con el formato de la institución. Sin pistas hasta el final.',
