...
export const pt: Dict = {
  common: {
    ...
    whatsapp: 'Combinar o pagamento no WhatsApp',
    language: 'Idioma',
    menu: 'Menu',
  ...
  wa: {
    ...
    info: 'Olá, quero combinar o pagamento do RUMBO.',
    short: 'Olá, quero combinar um pagamento do RUMBO.',
  ...
  proof: {
    ...
    extras: [
      ...
      ['Simulados cronometrados', 'Com o formato de cada instituição e o relógio correndo.'],
    ],
    startupTitle: 'Com as cartas na mesa',
    startupBody:
      'RUMBO é um projeto jovem, feito em Lima. Reúne em um só lugar quatro métodos já comprovados separadamente: repetição espaçada, prática de recuperação, aprendizagem visual e retorno imediato. O que acrescenta é tê-los juntos, organizados e ao alcance de uma família peruana, com o conteúdo da prova peruana. Cresce a cada semana e, se algo não encaixa, a gente escuta e corrige.',
  },
  ...
  landing: {
    ...
    faq: [
      ...
      { q: 'Serve para ISIL, USIL, UPC ou Universidad de Lima?', a: 'Serve, e vale dizer até onde vai a precisão. O ISIL publica que sua Avaliação de Potencial mede Aptidão Verbal e Raciocínio Matemático, e o simulado é montado com essas duas áreas. As outras instituições não publicam quanto pesa cada área, então nossas proporções são uma estimativa razoável, não um dado oficial: servem para treinar o formato e o relógio, não para prever a prova. Nenhuma dessas instituições tem vínculo com o RUMBO.' },
    ...
    footerSupport: 'Combinar meu pagamento',
  ...
  guide: {
    ...
    steps: [
      ...
      },
      {
        ...
        time: '25 min',
        body: 'Prova completa, cronometrada e com o formato da instituição que você escolher. Sem dicas até entregar, como no dia de verdade.',
  ...
  app: {
    ...
    quickExamBody: 'Questões cronometradas com o formato da instituição. Sem dicas até o fim.',
